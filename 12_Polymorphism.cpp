...
An Abstract base class can't be used to instantiate objects, but it can be used to create pointers - to
objects of derived (non-abstract) classes - which can be dereferenced.
*/
